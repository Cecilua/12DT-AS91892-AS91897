<?php
    ...
    if ($filters_str != "") {
        $filter_query = $filter_query." WHERE product_info.nutritional_info_id in (".$filters_str.") GROUP BY product_id HAVING COUNT(product_info.nutritional_info_id) = ".count($menu_filters);
    }
